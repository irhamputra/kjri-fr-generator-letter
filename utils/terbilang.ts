...
function terbilangWithKoma(num: number) {
  const [nilai, koma] = num.toString().split(".");
  return koma ? terbilang(+nilai) + " Koma " + terbilang(+koma) : terbilang(+nilai);
}

export default terbilang;
export { terbilangWithKoma };
